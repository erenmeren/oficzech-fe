...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <div className="absolute flex text-white mt-72 ml-52 mr-96 place-items-center">
          <div className="pr-10">
            <LeftArrowIcon height={45} width={45} alt="Left icon" fill="#fff" />
            {/* <Image src={lArrowIcon} height={45} width={45} alt="Left icon" /> */}
          </div>
          <div>
            <p className="text-8xl">
              Çekya’da Yeni Bir Hayat mi istiyorsunuz ?
            </p>
          ...
          <div className="pl-10">
            <RightArrowIcon
              ...
              fill="#fff"
            />
            {/* <Image src={rArrowIcon} height={45} width={45} alt="Right icon" /> */}
          </div>
        </div>
      </div>
      {/* second page */}
      <div className="mx-60 mb-40">
        <div className="">
          <div className="grid grid-rows-2 grid-flow-col gap-4 px-10">
            ...
            <div className="relative row-span-2 bg-[#383838] text-white rounded-b-lg  ">
              <div className="absolute w-full h-20 -top-20 bg-[var(--primary-color)] rounded-t-lg  px-10 pt-6">
                <span className="text-2xl">Bizimle İletişime Girin</span>
              </div>
              <div className="px-10">
...
const ServicesCard = ({ name, img, alt }: any) => {
  return (
    <div className="bg-[#F4F5F6] rounded-lg">
      ...
      />
      <div className="h-28 p-10 text-2xl">{name}</div>
    </div>
  );
};
...
const BlogCard = ({ header, text, pageURL }: any) => {
  return (
    <div className="bg-[#F4F5F6] rounded-lg p-10">
      ...
      <span className="text-[#7A8192]">{text}</span>
      <br />
